...
- Updated default `soft_capex` factors 
...
- Updated default `project_capex` values
...
- Included onshore substation costs in BOS CapEx and project breakdown 
...
- Cable configuration file updates 
