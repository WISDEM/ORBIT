...
def myformat(
    ...
    def myformat(
        myax, linewidth=linewidth, xticklabel=xticklabel, yticklabel=yticklabel
    ):
        if mode.lower() == "show":
            ...
            myax.set_title(
                myax.get_title(), size=titleSize + deltaShow, weight="bold"
            )
            myax.set_xlabel(
                myax.get_xlabel(), size=axLabelSize + deltaShow, weight="bold"
            )
            myax.set_ylabel(
                myax.get_ylabel(), size=axLabelSize + deltaShow, weight="bold"
            )
